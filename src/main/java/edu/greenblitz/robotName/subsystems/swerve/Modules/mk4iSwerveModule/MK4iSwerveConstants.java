...
public class MK4iSwerveConstants {
	...
	public static SwerveModuleConfigObject MK4I_MODULE_FRONT_LEFT = new SwerveModuleConfigObject(31, 30, 32, Rotation2d.fromRotations(0),false);
	public static SwerveModuleConfigObject MK4I_MODULE_FRONT_RIGHT = new SwerveModuleConfigObject(41, 40, 42,Rotation2d.fromRotations(0) ,true);
	public static SwerveModuleConfigObject MK4I_MODULE_BACK_LEFT = new SwerveModuleConfigObject(11, 10, 12, Rotation2d.fromRotations(0),false);
	public static SwerveModuleConfigObject MK4I_MODULE_BAK_RIGHT = new SwerveModuleConfigObject(21, 20, 22, Rotation2d.fromRotations(0),true);
